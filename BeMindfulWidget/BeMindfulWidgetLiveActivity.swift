//
//  BeMindfulWidgetLiveActivity.swift
//  BeMindfulWidget
//
...
struct BeMindfulWidgetAttributes: ActivityAttributes {
...
struct BeMindfulWidgetLiveActivity: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: BeMindfulWidgetAttributes.self) { context in
